    ...
    public void nhap(String maNV, int thang, int nam) {
        ...
        while (true) {
            ...
            if (tong <= check.lastDayOfMonth(thang, nam)) {
                ...
                System.out.println("Tong so ngay vua nhap \"" + tong + "\" vuot qua so ngay cua " + thang + "/" + nam + " la " + check.lastDayOfMonth(thang, nam) + " ngay.");
            }
        }
        this.maNV = maNV;
        this.thang = thang;
        ...
        this.khongCong = check.lastDayOfMonth(thang, nam) - tong;
    }
