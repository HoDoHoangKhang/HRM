...
public class LUONG implements Serializable, NhapXuat {
    ...
    public void nhap(String maNV, int thang, int nam, float soNgayCong, long luongCoBan, float heSoLuong) {
        this.maNV = maNV;
        this.thang = thang;
        this.nam = nam;
        this.luongCoBan = luongCoBan;
        this.heSoLuong = heSoLuong;
        this.luong = (long) ((this.luongCoBan * this.heSoLuong) / 26 * soNgayCong);
    }
